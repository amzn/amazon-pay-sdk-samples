                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            <a class="navbar-brand start-over" href="#">Pay with Amazon CSHARP SDK Simple Checkout</a>
                        </div>
...
unsuccessful you would see an error response.
                    ...
                    <p>
                        ...
                        of making a separate <em>Capture</em> API cal for <strong>(Recommended only for Digital Goods)</strong> we can set the <strong>CaptureNow</strong>
