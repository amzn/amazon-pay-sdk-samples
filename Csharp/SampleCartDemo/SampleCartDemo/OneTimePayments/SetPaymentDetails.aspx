            ...
            <nav class="navbar navbar-default">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <a class="navbar-brand start-over" href="#">Pay with Amazon C# SDK Simple Checkout</a>
                    </div>
                                    ...
                                    success: function (data) {
                                        $.each(data.d, function (key, value) {
                                            if (key == "getOrderReferenceDetailsResponse") {
                                                $("#get_details_response").append(key + " " + value);
                                            }
                                            else if (key == "setOrderReferenceDetailsResponse") {
                                                $("#setOrderReferenceDetailsResponse").append(key + " " + value);
                                            }
                                        });
                                    }
                                });
